...
import { products } from "../assets/data/homeStickers.js";
    ...
    <section className="py-8">
      <div className=" mx-auto px-3">
        <div className="flex justify-between">
            ...
            <Button as={Link} to='/category/Stickers%20%26%20Labels' color="dark" className="mb-6 hidden md:block">
            Explore More
            </Button>
            <Button as={Link} to='/category/Stickers%20%26%20Labels' size="xs" color="dark" className="mb-6 block md:hidden">
            Explore More
            </Button>
        </div>
