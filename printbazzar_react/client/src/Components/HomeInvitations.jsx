    ...
    <section className="py-8">
      <div className=" mx-auto px-3">
        <div className="flex justify-between">
            ...
            <Button as={Link} to='/category/Invitations' color="dark" className="mb-6 hidden md:block">
            Explore More
            </Button>
            <Button as={Link} to='/category/Invitations' size="xs" color="dark" className="mb-6 block md:hidden">
            Explore More
            </Button>
        </div>
