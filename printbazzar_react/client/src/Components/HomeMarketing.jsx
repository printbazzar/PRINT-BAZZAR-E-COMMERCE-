    ...
    <section className="py-8">
      <div className=" mx-auto px-3">
        <div className="flex justify-between">
            ...
            <Button as={Link} to='/category/Marketing%20and%20Promotionals%20Items' color="dark" className="mb-6 hidden md:block">
            Explore More
            </Button>
            <Button as={Link} to='/category/Marketing%20and%20Promotionals%20Items' size="xs" color="dark" className="mb-6 block md:hidden">
            Explore More
            </Button>
        </div>
