    ...
    <section className="py-12 bg-gray-50 border-y border-gray-200 my-8">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto mb-10">
          <span className="text-xs uppercase font-black tracking-widest text-black bg-yellow-400 px-3 py-1 rounded-md shadow-xs">
            SIMPLE & HASSLE-FREE
          </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {steps.map((step, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-200/80 shadow-xs relative hover:shadow-lg hover:border-yellow-400 transition-all flex flex-col justify-between group"
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-14 h-14 bg-yellow-400 text-black rounded-2xl flex items-center justify-center font-bold shadow-xs group-hover:scale-105 transition-transform">
                      <Icon className="w-7 h-7 text-black" />
                    </div>
                    <span className="text-3xl font-black text-gray-300 font-mono">{step.number}</span>
                  </div>
