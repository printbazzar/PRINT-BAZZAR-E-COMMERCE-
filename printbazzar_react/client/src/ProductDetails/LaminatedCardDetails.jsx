...
import Image1 from "../assets/images/business_card/laminated_card.png";
import Thumbnail1 from "../assets/images/business_card/laminated_card.png";
import Thumbnail2 from "../assets/images/business_card/laminate_mtrl.png";
...
export function LaminatedCardDetails() {
  ...
  const handleSubmit = () => {
    const message = `
    *Laminated Business Card (#PB0002)*:
    ...
    <div className="mx-auto px-4 py-8 max-w-full">
      ...
      <div className="mt-5 flex flex-col justify-center md:flex-row">
        ...
        <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
          <h3 className="font-medium text-3xl">Laminated Business Card</h3>
