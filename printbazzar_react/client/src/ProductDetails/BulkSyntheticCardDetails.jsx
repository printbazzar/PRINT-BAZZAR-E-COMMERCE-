...
import Image1 from "../assets/images/business_card/bulk_synthetic.jpg";
import Thumbnail1 from "../assets/images/business_card/bulk_synthetic.jpg";
...
export function BulkSyntheticCardDetails() {
  ...
  const calculatePrice = () => {
    ...
    if (printingType === "Single Side") {
      if (design === "Yes Please") {
        if (quantity === "500") price = 500 + 200;
        else if (quantity === "1000") price = 700 + 200;
      } else if (design === "No Thank You") {
        if (quantity === "500") price = 500;
    ...
    if (printingType === "Double Side") {
      if (design === "Yes Please") {
        if (quantity === "1000") price = 800 + 400;
      } else if (design === "No Thank You") {
        if (quantity === "1000") price = 800;
      }
    }
  ...
  const handleSubmit = () => {
    const message = `
        *Bulk Synthetic Business Card (#PB0011)*:
        - Printing Type: ${printingType}
        - Quantity: ${quantity}
        - Design: ${design}
        - Price: ₹${totalPrice} incl (GST) + Shipping charges\n
        *15 Days Delivery (From Ordered Date)*
        ...
        <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
          ...
          <div className="mt-4">
            ...
            >
              ...
              {quantity == "1000" ? <option>Double Side</option> : null}
            </Select>
          </div>
          ...
          <div className="mt-4">
            <h3 className="font-medium text-3xl flex gap-2 text-red-700">
              <span className="text-sm sm:text-base flex items-center gap-2">
                <HiClock className="text-sm sm:text-xl" />15 Days Delivery
              </span>
              <span className="text-gray-500 text-sm sm:text-base">
                (From Ordered Date)
              </span>
