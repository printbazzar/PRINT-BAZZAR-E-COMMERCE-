...
import Image1 from "../assets/images/business_card/synthetic.jpg";
import Thumbnail1 from "../assets/images/business_card/synthetic.jpg";
import Thumbnail2 from "../assets/images/business_card/synthetic_mtrl.jpg";
import Thumbnail3 from "../assets/images/business_card/synthetic_mtrl2.jpg";
...
export function SyntheticCardDetails() {
  const [mainImage, setMainImage] = useState(Image1);
  const [microns, setMicrons] = useState("125 microns");
  ...
  useEffect(() => {
    calculatePrice();
  }, [microns, printingType, design, quantity]);
  ...
  const calculatePrice = () => {
    ...
    if (microns === "125 microns") {
      if (printingType === "Single Side") {
        if (design === "Yes Please") {
          if (quantity === "100") price = 350 + 200;
          else if (quantity === "200") price = 590 + 200;
          else if (quantity === "300") price = 670 + 200;
          else if (quantity === "500") price = 1000 + 200;
          else if (quantity === "1000") price = 1650 + 200;
        } else if (design === "No Thank You") {
          if (quantity === "100") price = 350;
          else if (quantity === "200") price = 590;
          else if (quantity === "300") price = 670;
          else if (quantity === "500") price = 1000;
          else if (quantity === "1000") price = 1650;
        }
      } else if (printingType === "Double Side") {
        if (design === "Yes Please") {
          if (quantity === "100") price = 450 + 400;
          else if (quantity === "200") price = 650 + 400;
          else if (quantity === "300") price = 890 + 400;
          else if (quantity === "500") price = 1300 + 400;
          else if (quantity === "1000") price = 2250 + 400;
        } else if (design === "No Thank You") {
          if (quantity === "100") price = 450;
          else if (quantity === "200") price = 650;
          else if (quantity === "300") price = 890;
          else if (quantity === "500") price = 1300;
          else if (quantity === "1000") price = 2250;
        }
      }
    } else if (microns === "200 microns") {
      if (printingType === "Single Side") {
        if (design === "Yes Please") {
          if (quantity === "100") price = 450 + 200;
          else if (quantity === "200") price = 700 + 200;
          else if (quantity === "300") price = 890 + 200;
          else if (quantity === "500") price = 1400 + 200;
          else if (quantity === "1000") price = 2250 + 200;
        } else if (design === "No Thank You") {
          if (quantity === "100") price = 450;
          else if (quantity === "200") price = 700;
          else if (quantity === "300") price = 890;
          else if (quantity === "500") price = 1400;
          else if (quantity === "1000") price = 2250;
        }
      } else if (printingType === "Double Side") {
        if (design === "Yes Please") {
          if (quantity === "100") price = 500 + 400;
          else if (quantity === "200") price = 850 + 400;
          else if (quantity === "300") price = 1200 + 400;
          else if (quantity === "500") price = 1750 + 400;
          else if (quantity === "1000") price = 2950 + 400;
        } else if (design === "No Thank You") {
          if (quantity === "100") price = 500;
          else if (quantity === "200") price = 850;
          else if (quantity === "300") price = 1200;
          else if (quantity === "500") price = 1750;
          else if (quantity === "1000") price = 2950;
        }
      }
    } else if (microns === "300 microns") {
      if (printingType === "Single Side") {
        if (design === "Yes Please") {
          if (quantity === "100") price = 550 + 200;
          else if (quantity === "200") price = 900 + 200;
          else if (quantity === "300") price = 1300 + 200;
          else if (quantity === "500") price = 2000 + 200;
          else if (quantity === "1000") price = 3660 + 200;
        } else if (design === "No Thank You") {
          if (quantity === "100") price = 550;
          else if (quantity === "200") price = 900;
          else if (quantity === "300") price = 1300;
          else if (quantity === "500") price = 2000;
          else if (quantity === "1000") price = 3660;
        }
      } else if (printingType === "Double Side") {
        if (design === "Yes Please") {
          if (quantity === "100") price = 600 + 400;
          else if (quantity === "200") price = 1000 + 400;
          else if (quantity === "300") price = 1450 + 400;
          else if (quantity === "500") price = 2250 + 400;
          else if (quantity === "1000") price = 4200 + 400;
        } else if (design === "No Thank You") {
          if (quantity === "100") price = 600;
          else if (quantity === "200") price = 1000;
          else if (quantity === "300") price = 1450;
          else if (quantity === "500") price = 2250;
          else if (quantity === "1000") price = 4200;
        }
      }
    }
  ...
  const handleSubmit = () => {
    const message = `
        *Synthetic Business Card (#PB0010)*:
        - Microns: ${microns}
    ...
    <div className="mx-auto px-4 py-8 max-w-full">
      ...
      <div className="mt-5 flex flex-col justify-center md:flex-row">
        ...
        <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
          <h3 className="font-medium text-3xl">Synthetic Business Card</h3>
