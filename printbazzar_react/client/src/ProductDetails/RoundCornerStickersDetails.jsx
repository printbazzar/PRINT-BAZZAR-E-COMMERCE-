...
import Image1 from "../assets/images/stickers&labels/rounded_corner_shape.jpg";
import Thumbnail1 from "../assets/images/stickers&labels/rounded_corner_shape.jpg";
...
export function RoundCornerStickersDetails() {
      ...
      <div className="mt-5 flex flex-col justify-center md:flex-row">
        ...
        <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
          <h3 className="font-medium text-2xl sm:text-3xl flex items-center gap-5">
            Round Corner Stickers <br />{" "}
            <small className="text-base">(#PB0046)</small>
          </h3>
          {/* Form Fields */}
