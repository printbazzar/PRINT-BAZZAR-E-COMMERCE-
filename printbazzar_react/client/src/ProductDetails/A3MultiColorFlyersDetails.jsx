import {
  ...
  import Image1 from "../assets/images/marketing_materials/a3_flyer.jpg";
  import Thumbnail1 from "../assets/images/marketing_materials/a3_flyer.jpg";
  import Thumbnail2 from "../assets/images/marketing_materials/a3_flyer_mrtl.jpg";
  ...
  export function A3MultiColorFlyersDetails() {
    ...
    const [size, setSize] = useState("A3 (420x280 mm)");
    ...
    const calculatePrice = () => {
      ...
      if(printingLocation === 'Single Side'){
        if (size === "A3 (420x280 mm)") {
            if (quantity === "1000") price = 3850;
            else if (quantity === "2000") price = 6800;
            else if (quantity === "5000") price = 15100;
            else if (quantity === "10000") price = 25800;
      }
        ...
        if (size === "A3 (420x280 mm)") {
            if (quantity === "1000") price = 5470;
            else if (quantity === "2000") price = 8700;
            else if (quantity === "5000") price = 16100;
            else if (quantity === "10000") price = 28200;
      }
        if(design === 'Yes Please'){
            price += 1200
          }
        ...
        <div className="mt-5 flex flex-col justify-center md:flex-row">
          ...
          <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
            <h3 className="font-medium text-3xl flex items-center gap-5">
              A3 Multi Color Flyers <br /> <small className="text-base">(#PB0035)</small>
            </h3>
          ...
          <div className="px-5 mt-5">
            ...
            <ul className="text-base leading-relaxed text-gray-500 list-disc">
              ...
              <li>
                ...
                Available in standard A3 size providing
