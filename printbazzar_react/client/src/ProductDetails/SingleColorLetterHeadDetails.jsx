import {
  ...
  import Image1 from "../assets/images/business_essen/single_letterhead.jpg";
  import Thumbnail1 from "../assets/images/business_essen/single_letterhead.jpg";
  import Thumbnail2 from "../assets/images/business_essen/single_letterhead_mtrl.jpg";
  import Thumbnail3 from "../assets/images/business_essen/a4anda5.jpg";
...
import { BusinessEssentialsRelated } from "../RelatedProducts/BusinessEssentialsRelated";
  ...
  export function SingleColorLetterHeadDetails() {
    const [mainImage, setMainImage] = useState(Image1);
    const [papertype, setPapertype] = useState("70 gsm Maplitho Paper");
    const [color, setColor] = useState("Single Color");
    ...
    useEffect(() => {
      calculatePrice();
    }, [finishing, design, quantity,size]);
    ...
    const calculatePrice = () => {
      ...
      if(size === "A4"){
        if(finishing === "Loose Sheet"){
            if(quantity === "500") price = 700
            else if(quantity === "1000") price = 1180
            else if(quantity === "1500") price = 1770
            else if(quantity === "2000") price = 2360
            else if(quantity === "5000") price = 5300
        }

        else if(finishing === "Pad Finishing"){
            if(quantity === "500") price = 850
            else if(quantity === "1000") price = 1420
            else if(quantity === "1500") price = 2120
            else if(quantity === "2000") price = 2850
            else if(quantity === "5000") price = 6490
        }
      }
    ...
    const handleSubmit = () => {
      const message = `
        *Single Color Letter Head(#PB0055)*:
        - Color: ${color}
      ...
      <div className="mx-auto px-4 py-8 max-w-full">
        ...
        <div className="mt-5 flex flex-col justify-center md:flex-row">
          ...
          <h3 className="font-medium text-2xl sm:text-3xl flex items-center gap-5">
              Letter Head (Single Color) <br />{" "}
              <small className="text-base">(#PB0055)</small>
            </h3>
            ...
            <div className="mt-4">
              ...
              <Select value={colorOptions} onChange={(e) => setColorOptions(e.target.value)}>
                <option>Red</option>
                <option>Green</option>
                <option>Royal Blue</option>
                <option>Meganta (Pink)</option>
                <option>Black</option>
              </Select>
            </div>
            ...
            <div className="mt-4">
              ...
              >
                <option>70 gsm Maplitho Paper</option>
              </Select>
            </div>
        ...
        <div className="mt-5 max-w-4xl 2xl:max-w-full xl:mt-20 flex flex-col ">
          ...
          <div className="px-5 mt-5">
            ...
            <ul className="text-base leading-relaxed text-gray-500 list-disc">
              ...
              <li>
                {" "}
                <span className="text-black font-medium">Paper Type:</span>{" "}
                70 GSM MAPLITHO PAPER</li>
              <li>
                <span className="text-black font-medium">Size:</span> <br />
                 A4
              </li>
              <li>
                <span className="text-black font-medium">Color Option:</span>
                <br />RED,GREEN,ROYAL BLUE, MEGANTA (PINK), BLACK
              </li>
              <li>
                <span className="text-black font-medium">Finishing:</span>
                <br />Loose Sheet & Pad Finish</li>
            </ul>
          </div>
        </div>
