import {
  ...
  import Image1 from "../assets/images/marketing_materials/miniqr.jpg";
  import Thumbnail1 from "../assets/images/marketing_materials/miniqr.jpg";
  import Thumbnail2 from "../assets/images/marketing_materials/miniqr_mtrl.jpg";
  import Thumbnail3 from "../assets/images/marketing_materials/miniqr_mtrl2.jpg";
  ...
  export function MiniQRStandDetails() {
    const [mainImage, setMainImage] = useState(Image1);
    const [qrType, setQrType] = useState("Social Media QR");
    const [size, setSize] = useState("6x4 inch");
        ...
        <div className="mt-5 flex flex-col justify-center md:flex-row">
          ...
          <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
            <h3 className="font-medium text-3xl flex items-center gap-5">
              Mini QR Stand <br /> <small className="text-base">(#PB0040)</small>
            </h3>
            ...
            <div className="mt-4">
              ...
              <Select value={qrType} onChange={(e) => {setQrType(e.target.value)}}>
                <option>Social Media QR</option>
                <option>Payment QR</option>
                <option>Google Review QR</option>
                <option>Whatsapp QR</option>
              </Select>
            </div>
            ...
            {design === "No Thank You" && (
              <Button
                ...
                as={Link}
                to="https://www.canva.com/search?q=qr%20stand"
                target="_blank"
              >
