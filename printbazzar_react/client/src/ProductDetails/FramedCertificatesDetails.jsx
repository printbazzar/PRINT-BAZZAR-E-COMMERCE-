...
import Image1 from "../assets/images/business_essen/framed_certi.jpg";
import Thumbnail1 from "../assets/images/business_essen/framed_certi.jpg";
import Thumbnail2 from "../assets/images/business_essen/framed_certi_mtrl.jpg";
import Thumbnail3 from "../assets/images/business_essen/framed_certi_mtrl2.jpg";
      ...
      <div className="mt-5 flex flex-col justify-center md:flex-row">
        ...
        <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
          <h3 className="font-medium text-3xl flex items-center gap-5">
            Framed Certificates <br />{" "}
            <small className="text-base">(#PB0028)</small>
          </h3>
          ...
          <div className="mt-4">
            ...
            >
              <option>Plain Black</option>
              <option>Plain White</option>
              <option>Checked Black</option>
              <option>Checked Brown</option>
              <option>Brown with Gold</option>
              <option>ZigZag Brown</option>
            </Select>
          </div>
          ...
          <div className="mt-4">
            ...
            <Link
              target="_blank"
              to="https://wa.me/9629098565?text=I%20want%20to%20enquire%20about%20Framed%20Certificates%20quantities"
              className="font-medium text-sm text-red-600 flex items-center gap-1 mt-2"
            >
              For bulk quantities, Click{" "}
              <FaWhatsapp className="text-green-400 text-lg" /> to contact us
              for more details
            </Link>
          </div>
