...
import Image1 from "../assets/images/business_card/textured_card.jpg";
import Thumbnail1 from "../assets/images/business_card/textured_card.jpg";
import Thumbnail2 from "../assets/images/business_card/textured_mtrl_2.png";
import Thumbnail3 from "../assets/images/business_card/textured_mtrl.png";
...
export function TexturedCardDetails() {
  const [mainImage, setMainImage] = useState(Image1);
  const [lamination, setLamination] = useState("Needle Point (300 gsm)");
  ...
  const calculatePrice = () => {
    ...
    if (printingType === "Single Side") {
      if (design === "Yes Please") {
        ...
        else if (quantity === "200") price = 450 + 200;
        else if (quantity === "300") price = 590 + 200;
        else if (quantity === "500") price = 800 + 200;
        else if (quantity === "1000") price = 1360 + 200;
      } else if (design === "No Thank You") {
        if (quantity === "100") price = 250;
        else if (quantity === "200") price = 450;
        else if (quantity === "300") price = 590;
        else if (quantity === "500") price = 800;
        else if (quantity === "1000") price = 1360;
      }
    ...
    if (printingType === "Double Side") {
      if (design === "Yes Please") {
        if (quantity === "100") price = 330 + 400;
        else if (quantity === "200") price = 520 + 400;
        else if (quantity === "300") price = 708 + 400;
        else if (quantity === "500") price = 960 + 400;
        else if (quantity === "1000") price = 1560 + 400;
      } else if (design === "No Thank You") {
        if (quantity === "100") price = 330;
        else if (quantity === "200") price = 520;
        else if (quantity === "300") price = 708;
        else if (quantity === "500") price = 960;
        else if (quantity === "1000") price = 1560;
      }
    }
    if (cornerFinishing === "Rounded") {
      if (quantity == "100" || quantity == "200" || quantity == "300") {
    ...
    <div className="mx-auto px-4 py-8 max-w-full">
      ...
      <div className="mt-5 flex flex-col justify-center md:flex-row">
        ...
        <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
          <h3 className="font-medium text-3xl">Textured Business Card</h3>
