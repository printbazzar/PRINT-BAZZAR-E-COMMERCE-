...
import Image1 from "../assets/images/business_essen/premium_certi_mtrl.jpg";
import Thumbnail1 from "../assets/images/business_essen/premium_certi_mtrl.jpg";
import Thumbnail2 from "../assets/images/business_essen/premium_certi.jpg";
...
export function PremiumCertificatesDetails() {
  const [mainImage, setMainImage] = useState(Image1);
  const [printingLocation, setprintingLocation] = useState("Single Side");
  const [material, setMaterial] = useState("Flat Foil");
  ...
  const calculatePrice = () => {
    ...
    if(material === 'Flat Foil'){
      if (quantity === "24") price = 1300;
      else if (quantity === "50") price = 1850;
      else if (quantity === "80") price = 2500;
      else if (quantity === "100") price = 2720;
      else if (quantity === "130") price = 3300;
      else if (quantity === "150") price = 3660;
      else if (quantity === "200") price = 4600;
      else if (quantity === "250") price = 5550;
      else if (quantity === "300") price = 6600;
    }
    else if(material === 'Gold Foil'){
      if (quantity === "24") price = 1770;
      else if (quantity === "50") price = 2700;
      else if (quantity === "80") price = 3780;
      else if (quantity === "100") price = 4130;
      else if (quantity === "130") price = 5080;
      else if (quantity === "150") price = 5660;
      else if (quantity === "200") price = 7200;
      else if (quantity === "250") price = 9800;
      else if (quantity === "300") price = 10500;
    }
    else if(material === 'Embossed UV'){
      if (quantity === "24") price = 1550;
      else if (quantity === "50") price = 2300;
      else if (quantity === "80") price = 3070;
      else if (quantity === "100") price = 3380;
      else if (quantity === "130") price = 4130;
      else if (quantity === "150") price = 4720;
      else if (quantity === "200") price = 5900;
      else if (quantity === "250") price = 8000;
      else if (quantity === "300") price = 8600;
    }
  ...
  const handleSubmit = () => {
    const message = `
            *Premium Certificates (#PB0026)*:
            - Printing Location: ${printingLocation}
            - Special Finish: ${material}
            - Orientation: ${orientation}
            - Quantity: ${quantity}
            - Design: ${design}
            - Price: ₹${totalPrice} incl (GST) + Shipping charges

            *5-6 Days Delivery (From Ordered Date)*
          `;
      ...
      <div className="mt-5 flex flex-col justify-center md:flex-row">
        ...
        <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
          <h3 className="font-medium text-3xl flex items-center gap-5">
            Premium Certificates <br /> <small className="text-base">(#PB0026)</small>
          </h3>
          ...
          <div className="mt-4">
            ...
            >
              <option>Flat Foil</option>
              <option>Gold Foil</option>
              <option>Embossed UV</option>
            </Select>
          </div>
          ...
          <h3 className="font-medium text-3xl flex gap-2 text-red-700">
            <span className="text-sm sm:text-base flex items-center gap-2">
              <HiClock className="text-sm sm:text-xl" />5-6 Days Delivery
            </span>
            <span className="text-gray-500 text-sm sm:text-base">
              (From Ordered Date)
            </span>
        ...
        <div className="px-5 mt-5">
          ...
          <ul className="text-base leading-relaxed text-gray-500">
            {" "}
              ...
              <li>4.Special Finishes: Flat Foil, Gold Foil and Embossed UV.</li>
          </ul>
        </div>
      </div>
