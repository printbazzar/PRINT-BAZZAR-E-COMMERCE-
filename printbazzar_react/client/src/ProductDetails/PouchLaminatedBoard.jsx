import {
  ...
  import Image1 from "../assets/images/marketing_materials/laminated_board.jpg";
  import Thumbnail1 from "../assets/images/marketing_materials/laminated_board.jpg";
  import Thumbnail2 from "../assets/images/marketing_materials/laminated_board_mtrl.jpg";
  import Thumbnail3 from "../assets/images/marketing_materials/laminated_board_mtrl2.jpg";
  ...
  export function PouchLaminatedBoardDetails() {
    ...
    const calculatePrice = () => {
      ...
      if(printingLocation === 'Single Side'){
        if (size === "A4 (210x297 mm)") {
            if (quantity === "1") price = 60;
            else if (quantity === "2") price = 120;
            else if (quantity === "3") price = 180;
            else if (quantity === "4") price = 200;
            else if (quantity === "5") price = 250;
            else  if (quantity === "10") price = 400;
      }
      else if (size === "A3 (420x280 mm)") {
        if (quantity === "1") price = 100;
            if (quantity === "2") price = 200;
            else if (quantity === "3") price = 300;
            else if (quantity === "4") price = 380;
            else if (quantity === "5") price = 460;
            else if (quantity === "10") price = 800;
        }
        ...
        if (size === "A4 (210x297 mm)") {
            if (quantity === "1") price = 70;
            else if (quantity === "2") price = 140;
            else if (quantity === "3") price = 210;
            else if (quantity === "4") price = 250;
            else if (quantity === "5") price = 300;
            else if (quantity === "10") price = 500;
      }
      else if (size === "A3 (420x280 mm)") {
        if (quantity === "1") price = 120;
            if (quantity === "2") price = 240;
            else if (quantity === "3") price = 360;
            else if (quantity === "4") price = 460;
            else if (quantity === "5") price = 550;
            else if (quantity === "10") price = 1000;
        }
        if(design === 'Yes Please'){
            price += 600
          }
        ...
        <div className="mt-5 flex flex-col justify-center md:flex-row">
          ...
          <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
            <h3 className="font-medium text-3xl flex items-center gap-5">
              Pouch Laminated Board <br /> <small className="text-base">(#PB0038)</small>
            </h3>
        ...
        <div className="mt-5 max-w-4xl 2xl:max-w-full xl:mt-20 flex flex-col ">
          ...
          <div className="px-5 mt-5">
            ...
            <ul className="text-base leading-relaxed text-gray-500 list-disc">
              ...
              <li>
                4.Great and Strong For Long term 
              </li>
            </ul>
          </div>
        </div>
