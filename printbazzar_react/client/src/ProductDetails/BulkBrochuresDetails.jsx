import {
  ...
  import Image1 from "../assets/images/business_essen/bulk_brochure.jpg";
  import Thumbnail1 from "../assets/images/business_essen/bulk_brochure.jpg";
...
import { BusinessEssentialsRelated } from "../RelatedProducts/BusinessEssentialsRelated";
  ...
  export function BulkBrochuresDetails() {
    const [mainImage, setMainImage] = useState(Image1);
    const [fold, setFold] = useState("No Fold");
    const [materials, setMaterials] = useState("130gsm");
    const [printingLocation, setPrintingLocation] = useState("Double Side");
    ...
    const calculatePrice = () => {
      ...
      if(materials === '130gsm'){
        if (size === "A4 (210x297 mm)") {
            if (quantity === "1000") price = 3540;
            else if (quantity === "2000") price = 6850;
            else if (quantity === "3000") price = 10700;
      }
      else if (size === "A5 (210x140 mm)") {
        if (quantity === "1000") price = 3200;
            else if (quantity === "2000") price = 3600;
            else if (quantity === "3000") price = 8800;
        }
      }

      else if(materials === '170gsm'){
        if (size === "A4 (210x297 mm)") {
            if (quantity === "1000") price = 4300;
            else if (quantity === "2000") price = 7500;
            else if (quantity === "3000") price = 11200;
        }
      else if (size === "A5 (210x140 mm)") {
        if (quantity === "1000") price = 3600;
            else if (quantity === "2000") price = 3850;
            else if (quantity === "3000") price = 7200;
        }
      }

      else if(materials === '300gsm'){
        if (size === "A4 (210x297 mm)") {
            if (quantity === "1000") price = 5600;
            else if (quantity === "2000") price = 9500;
            else if (quantity === "3000") price = 14800;
        }
      else if (size === "A5 (210x140 mm)") {
        if (quantity === "1000") price = 5600;
            else if (quantity === "2000") price = 9500;
        ...
        <div className="mt-5 flex flex-col justify-center md:flex-row">
          ...
          <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
            <h3 className="font-medium text-3xl flex items-center gap-5">
              Bulk Brochures <br /> <small className="text-base">(#PB0032)</small>
            </h3>
            ...
            <div className="mt-4">
              ...
              <label className="block font-medium text-sm text-gray-700">
              Choose a quantity between 1000 - 3000 for instant ordering. For higher quantities, Contact Us.
              </label>
            </div>
