import {
  ...
  import Image1 from "../assets/images/marketing_materials/viboothimc.jpg";
  import Thumbnail1 from "../assets/images/marketing_materials/viboothimc.jpg";
  import Thumbnail2 from "../assets/images/marketing_materials/viboothimc_mtrl.jpg";
  import Thumbnail3 from "../assets/images/marketing_materials/viboothimc_mtrl2.jpg";
  ...
  export function ViboothiCoverMultiColorDetails() {
    const [mainImage, setMainImage] = useState(Image1);
    const [printingLocation, setPrintingLocation] = useState("Single Side");
    const [size, setSize] = useState("6x8 cm");
    const [thickness, setThickness] = useState("100 gsm Art Paper");
    ...
    const calculatePrice = () => {
      let price = 0;
       ...
       if(quantity === "4000") price = 3100;
       else if(quantity === "8000") price = 5450;
       else if(quantity === "12000") price = 8500;
       else if(quantity === "20000") price = 14160;
    ...
    const handleSubmit = () => {
          ...
          const message = `
              *Viboothi Cover Multi Color (#PB0091)*:
              - Size: ${size}
        ...
        <div className="mt-5 flex flex-col justify-center md:flex-row">
          ...
          <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
            <h3 className="font-medium text-3xl flex items-center gap-5">
              Viboothi Cover (Multi Color)<br /> <small className="text-base">(#PB0091)</small>
            </h3>
            ...
            <div className="mt-4">
              ...
              <Select value={thickness} onChange={(e) => {setThickness(e.target.value)}}>
                <option>100 gsm Art Paper</option>
            ...
            <div className="mt-4">
              <h3 className="font-medium text-3xl flex gap-2 text-red-700">
                <span className="text-sm sm:text-base flex items-center gap-2">
                  <HiClock className="text-sm sm:text-xl" />7 Days Delivery
                </span>
                <span className="text-gray-500 text-sm sm:text-base">
                  (From Ordered Date)
                </span>
        ...
        <div className="mt-5 max-w-4xl 2xl:max-w-full xl:mt-20 flex flex-col ">
          ...
          <div className="px-5 mt-5">
            ...
            <ul className="text-base leading-relaxed text-gray-500 list-disc">
              ...
              <li>
                4.Lightweight, professional signs you can set up anywhere. 
              </li>
            </ul>
          </div>
        </div>
