import {
  ...
  import Image1 from "../assets/images/business_essen/ID_card_retractor.jpg";
  import Thumbnail1 from "../assets/images/business_essen/ID_card_retractor.jpg";
  import Thumbnail2 from "../assets/images/business_essen/ID_card_retractor_mtrl.jpg";
  import Thumbnail3 from "../assets/images/business_essen/ID_card_retractor_mtrl2.jpg";
...
import { BusinessEssentialsRelated } from "../RelatedProducts/BusinessEssentialsRelated";
  ...
  export function IDCardRetractorDetails() {
    const [mainImage, setMainImage] = useState(Image1);
    const [size,setSize] = useState("54x86 mm");
        ...
        <div className="mt-5 flex flex-col justify-center md:flex-row">
          ...
          <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
            <h3 className="font-medium text-2xl sm:text-3xl flex items-center gap-5">
              ID Card Retractor<br /> <small className="text-base">(#PB0066)</small>
            </h3>
            <label className="block font-medium text-sm text-gray-700">
                Keep your ID within reach with a handy retractor clip.
              </label>
            {/* Form Fields */}
        ...
        <div className="mt-5 max-w-4xl 2xl:max-w-full xl:mt-20 flex flex-col ">
          ...
          <div className="px-5 mt-5">
            ...
            <ul className="text-base leading-relaxed text-gray-500 list-disc">
              ...
              <li>
                {" "}
                <span className="text-black font-medium">Retractor Size :</span>{" "}
                <br />
                Available in standard 54x86 mm providing ample space for ID Card
              </li>
              <li>
                {" "}
                <span className="text-black font-medium">Quantity:</span>{" "}
                <br />
                Order from as low as 1 units
              </li>
              <li>
                <span className="text-black font-medium">Color Options:</span> <br />
                Available in Black and Blue
              </li>
              <li>
                <span className="text-black font-medium">Features:</span>
                <br /> Suitable for any kind of industry and The best way to avoid tangles and clutter
              </li>
            </ul>
          </div>
        </div>
