...
import Image1 from "../assets/images/business_card/spotuv.jpg";
import Thumbnail1 from "../assets/images/business_card/spotuv.jpg";
import Thumbnail2 from "../assets/images/business_card/spotuv_mtrl.jpg";
...
export function SpotUVCardDetails() {
  ...
  const calculatePrice = () => {
    ...
    if (printingType === "Single Side") {
      if (design === "Yes Please") {
        if (quantity === "1000") price = 900 + 200;
      } else if (design === "No Thank You") {
        if (quantity === "1000") price = 900;
      }
    }

    if (printingType === "Double Side") {
      if (design === "Yes Please") {
        if (quantity === "1000") price = 1100 + 400;
      } else if (design === "No Thank You") {
        if (quantity === "1000") price = 1100;
      }
    }
    ...
    <div className="mx-auto px-4 py-8 max-w-full">
      ...
      <div className="mt-5 flex flex-col justify-center md:flex-row">
        ...
        <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
          <h3 className="font-medium text-3xl">Spot UV Business Card</h3>
