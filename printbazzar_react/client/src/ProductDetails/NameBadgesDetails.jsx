import {
  ...
  import Image1 from "../assets/images/marketing_materials/foamboard.jpg";
  import Thumbnail1 from "../assets/images/marketing_materials/foamboard.jpg";
  import Thumbnail2 from "../assets/images/marketing_materials/foamboard_mtrl.jpg";
  ...
  export function NameBadgesDetails() {
    ...
    const calculatePrice = () => {
      let price = 0;
        ...
        if (thickness === "3mm") price = quantity * 850;
        ...
        <div className="mt-5 flex flex-col justify-center md:flex-row">
          ...
          <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
            <h3 className="font-medium text-3xl flex items-center gap-5">
              Foam Boards <br /> <small className="text-base">(#PB0039)</small>
            </h3>
            <label className="block font-medium text-sm text-gray-700">
                1.Lightweight, professional signs you can set up anywhere <br />
                2.Solvent Printed Vinyl Pasting Method For Vibrant color and Eyecatching Outlook
            </label>
