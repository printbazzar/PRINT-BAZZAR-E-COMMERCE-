import {
  ...
  import Image1 from "../assets/images/Invitations/EventCards.jpg";
  import Thumbnail1 from "../assets/images/Invitations/EventCards.jpg";
...
import { InvitationRelated } from "../RelatedProducts/InvitationRelated";
  ...
  export function EventInvitationDetails() {
        ...
        <div className="mt-5 flex flex-col justify-center md:flex-row">
          ...
          <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
            <h3 className="font-medium text-2xl sm:text-3xl flex items-center gap-5">
              Event Invitation <br />{" "}
              <small className="text-base">(#PB0077)</small>
            </h3>
            {/* Form Fields */}
            ...
            {design === "No Thank You" && (
              <Button
                ...
                as={Link}
                to="https://www.canva.com/search?q=event%20invitations"
                target="_blank"
              >
