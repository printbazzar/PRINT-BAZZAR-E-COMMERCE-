import {
  ...
  import Image1 from "../assets/images/marketing_materials/single_flyer.jpg";
  import Thumbnail1 from "../assets/images/marketing_materials/single_flyer.jpg";
  ...
  export function SingleColorFlyersDetails() {
    const [mainImage, setMainImage] = useState(Image1);
    const [fold, setFold] = useState("No Fold");
    const [materials, setMaterials] = useState("60gsm Copier Paper");
    ...
    const calculatePrice = () => {
      ...
      if(printingLocation === 'Single Side'){
        if (size === "A4 (210x297 mm)") {
            if (quantity === "1000") price = 950;
            else if (quantity === "2000") price = 1900;
            else if (quantity === "3000") price = 2500;
            else if (quantity === "5000") price = 4400;
            else if (quantity === "6000") price = 5200;
            else if (quantity === "10000") price = 9050;
      }
      else if (size === "A5 (210x148 mm)") {
        if (quantity === "1000") price = 700;
        else if (quantity === "2000") price = 1000;
        else if (quantity === "3000") price = 1400;
        else if (quantity === "5000") price = 2200;
        else if (quantity === "6000") price = 2750;
        else if (quantity === "10000") price = 4600;
        }
      }

      else if(printingLocation === 'Double Side'){
        if (size === "A4 (210x297 mm)") {
            if (quantity === "1000") price = 1200;
            else if (quantity === "2000") price = 2400;
            else if (quantity === "3000") price = 3200;
            else if (quantity === "5000") price = 5750;
            else if (quantity === "6000") price = 6800;
            else if (quantity === "10000") price = 11550;
      }
      else if (size === "A5 (210x148 mm)") {
        if (quantity === "1000") price = 850;
        else if (quantity === "2000") price = 1200;
        else if (quantity === "3000") price = 1850;
        else if (quantity === "5000") price = 2880;
        else if (quantity === "6000") price = 3450;
        else if (quantity === "10000") price = 5750;
        }
      }
        ...
        <div className="mt-5 flex flex-col justify-center md:flex-row">
          ...
          <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
            <h3 className="font-medium text-3xl flex items-center gap-5">
              Single Color Flyers <br /> <small className="text-base">(#PB0033)</small>
            </h3>
            ...
            <div className="mt-4">
              ...
              >
                <option>60gsm Copier Paper</option>
              </Select>
            </div>
          ...
          <div className="px-5 mt-5">
            ...
            <ul className="text-base leading-relaxed text-gray-500 list-disc">
              ...
              <li>
                ...
                Available in standard A4 size and A5 size  providing
