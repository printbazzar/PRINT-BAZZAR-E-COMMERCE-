...
import Image1 from "../assets/images/business_card/premiumspot.jpg";
import Thumbnail1 from "../assets/images/business_card/premiumspot.jpg";
import Thumbnail2 from "../assets/images/business_card/premiumspot_mtrl.jpg";
import Thumbnail3 from "../assets/images/business_card/spotuv_mtrl2.jpg";
...
export function PremiumSpotUVCardDetails() {
  ...
  const calculatePrice = () => {
    ...
    if (printingType === "Single Side") {
      if (design === "Yes Please") {
        if (quantity === "1000") price = 650 + 200;
      } else if (design === "No Thank You") {
        if (quantity === "1000") price = 650;
      }
    }

    if (printingType === "Double Side") {
      if (design === "Yes Please") {
        if (quantity === "1000") price = 850 + 400;
      } else if (design === "No Thank You") {
    ...
    <div className="mx-auto px-4 py-8 max-w-full">
      ...
      <div className="mt-5 flex flex-col justify-center md:flex-row">
        ...
        <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
          <h3 className="font-medium text-3xl">Premium Spot UV Card</h3>
          ...
          <div className="mt-4">
            <h3 className="font-medium text-3xl flex gap-2 text-red-700">
              <span className="text-sm sm:text-base flex items-center gap-2">
                <HiClock className="text-sm sm:text-xl" />10 Days Delivery
              </span>
              <span className="text-gray-500 text-sm sm:text-base">
                (From Ordered Date)
              </span>
