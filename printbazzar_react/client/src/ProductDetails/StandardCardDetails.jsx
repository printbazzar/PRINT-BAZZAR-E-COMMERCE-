...
import Image1 from "../assets/images/business_card/standard_card.jpg"; // Import product image
import Thumbnail1 from "../assets/images/business_card/standard_card.jpg"; // Thumbnail image 1
import Thumbnail2 from "../assets/images/business_card/standard_mtrl.png"; // Thumbnail image 2
import Thumbnail3 from "../assets/images/business_card/standard_paper.png"; // Thumbnail image 3
...
export function StandardCardDetails() {
  ...
  const calculatePrice = () => {
    ...
    if (printingType === "Single Side") {
      if (design === "Yes Please") {
        if (quantity === "100") price = 200 + 200;
        else if (quantity === "200") price = 300 + 200;
        else if (quantity === "300") price = 380 + 200;
        else if (quantity === "500") price = 480 + 200;
        else if (quantity === "1000") price = 850 + 200;
      } else if (design === "No Thank You") {
        if (quantity === "100") price = 200;
        else if (quantity === "200") price = 300;
        else if (quantity === "300") price = 380;
        else if (quantity === "500") price = 480;
        else if (quantity === "1000") price = 850;
      }
    }

    if (printingType === "Double Side") {
      if (design === "Yes Please") {
        if (quantity === "100") price = 250 + 400;
        else if (quantity === "200") price = 360 + 400;
        else if (quantity === "300") price = 460 + 400;
        else if (quantity === "500") price = 670 + 400;
        else if (quantity === "1000") price = 1250 + 400;
      } else if (design === "No Thank You") {
        if (quantity === "100") price = 250;
        else if (quantity === "200") price = 360;
        else if (quantity === "300") price = 460;
        else if (quantity === "500") price = 670;
        else if (quantity === "1000") price = 1250;
      }
    }
      ...
      <div className="mt-5 flex flex-col justify-center md:flex-row">
        ...
        <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
          <h3 className="font-medium text-3xl flex items-center gap-5">
            ...
            <small className="text-base">(#PB0001)</small>
          </h3>
        ...
        <div className="px-5 mt-5">
          <ul className="text-base leading-relaxed text-gray-500 list-disc">
            ...
            <li>
              ...
              <br />
              <span className="text-black font-medium">Sharp:</span>
