...
import Image1 from "../assets/images/business_card/raiseduv_mtrl.jpg";
import Thumbnail1 from "../assets/images/business_card/raiseduv_mtrl.jpg";
import Thumbnail2 from "../assets/images/business_card/raiseduv.jpg";
import Thumbnail3 from "../assets/images/business_card/raiseduv_mtrl2.jpg";
...
export function RaisedUVCardDetails() {
  ...
  const calculatePrice = () => {
    ...
    if (printingType === "Single Side") {
      if (design === "Yes Please") {
        if (quantity === "100") price = 850 + 200;
        else if (quantity === "200") price = 1200 + 200;
        else if (quantity === "300") price = 1450 + 200;
        else if (quantity === "500") price = 1900 + 200;
        else if (quantity === "1000") price = 330 + 200;
      } else if (design === "No Thank You") {
        if (quantity === "100") price = 850;
        else if (quantity === "200") price = 1200;
        else if (quantity === "300") price = 1450;
        else if (quantity === "500") price = 1900;
        else if (quantity === "1000") price = 330;
      }
    }

    if (printingType === "Double Side") {
      if (design === "Yes Please") {
        if (quantity === "100") price = 950 + 400;
        else if (quantity === "200") price = 1900 + 400;
        else if (quantity === "300") price = 2360 + 400;
        else if (quantity === "500") price = 3100 + 400;
        else if (quantity === "1000") price = 5500 + 400;
      } else if (design === "No Thank You") {
        if (quantity === "100") price = 950;
        else if (quantity === "200") price = 1900;
        else if (quantity === "300") price = 2360;
        else if (quantity === "500") price = 3100;
        else if (quantity === "1000") price = 5500;
      }
    }
  ...
  const handleSubmit = () => {
    const message = `
        *Rasied UV Business Card (#PB0008)*:
    ...
    <div className="mx-auto px-4 py-8 max-w-full">
      ...
      <div className="mt-5 flex flex-col justify-center md:flex-row">
        ...
        <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
          <h3 className="font-medium text-3xl">Raised UV Business Card</h3>
          ...
          <div className="mt-4">
            ...
            <h3 className="font-medium text-3xl text-red-700">
              ₹{totalPrice}{" "}
              <span className="text-gray-500 text-base">(incl GST)</span> +{" "}
              <span className="text-gray-500 text-base">Shipping charges</span>
            </h3>
          </div>
          <div className="mt-4">
            <h3 className="font-medium text-3xl flex gap-2 text-red-700">
              <span className="text-base flex items-center gap-2">
                <HiClock className="text-xl" />5 Days Delivery
              </span>
          ...
          <div className="mt-4 flex items-center gap-2">
            ...
            <Label htmlFor="accept" className="flex text-md">
              I agree with the&nbsp;
              <a
