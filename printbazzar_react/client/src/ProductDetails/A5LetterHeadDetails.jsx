import {
  ...
  import Image1 from "../assets/images/business_essen/a5letterHead.jpg";
  import Thumbnail1 from "../assets/images/business_essen/a5letterHead.jpg";
...
import { BusinessEssentialsRelated } from "../RelatedProducts/BusinessEssentialsRelated";
  ...
  export function A5LetterHeadDetails() {
    ...
    const calculatePrice = () => {
      ...
      if(size === "A5"){
        if(finishing === "Loose Sheet"){
            if(quantity === "1000") price = 750
            else if(quantity === "2000") price = 1220
            else if(quantity === "3000") price = 1850
            else if(quantity === "4000") price = 2420
            else if(quantity === "10000") price = 5450
        }

        else if(finishing === "Pad Finishing"){
            if(quantity === "1000") price = 1150
            else if(quantity === "2000") price = 1690
            else if(quantity === "3000") price = 2560
            else if(quantity === "4000") price = 3360
            else if(quantity === "10000") price = 7800
        }
      }
      ...
      <div className="mx-auto px-4 py-8 max-w-full">
        ...
        <div className="mt-5 flex flex-col justify-center md:flex-row">
          ...
          <h3 className="font-medium text-2xl sm:text-3xl flex items-center gap-5">
              A5 Letter Head (Single Color)<br />{" "}
              <small className="text-base">(#PB0056)</small>
            </h3>
          ...
          <div className="px-5 mt-5">
            ...
            <ul className="text-base leading-relaxed text-gray-500 list-disc">
              ...
              <li>
                ...
                Available in A5 size , providing
