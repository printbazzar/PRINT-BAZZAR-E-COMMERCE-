...
import Image1 from "../assets/images/business_card/plantable_card_mtrl2.jpg";
import Thumbnail1 from "../assets/images/business_card/plantable_card_mtrl2.jpg";
import Thumbnail2 from "../assets/images/business_card/plantable_card.jpg";
import Thumbnail3 from "../assets/images/business_card/plantable_card_mtrl.jpg";
...
export function PlantablePaperCardDetails() {
  ...
  const calculatePrice = () => {
    ...
    if (printingType === "Single Side") {
      if (design === "Yes Please") {
        if (quantity === "100") price = 320 + 200;
        else if (quantity === "200") price = 420 + 200;
        else if (quantity === "300") price = 500 + 200;
        else if (quantity === "500") price = 660 + 200;
        else if (quantity === "1000") price = 1100 + 200;
      } else if (design === "No Thank You") {
        if (quantity === "100") price = 320;
        else if (quantity === "200") price = 420;
        else if (quantity === "300") price = 500;
        else if (quantity === "500") price = 660;
        else if (quantity === "1000") price = 1100;
      }
    }

    if (printingType === "Double Side") {
      if (design === "Yes Please") {
        if (quantity === "100") price = 400 + 400;
        else if (quantity === "200") price = 510 + 400;
        else if (quantity === "300") price = 610 + 400;
        else if (quantity === "500") price = 850 + 400;
        else if (quantity === "1000") price = 1600 + 400;
      } else if (design === "No Thank You") {
        if (quantity === "100") price = 400;
        else if (quantity === "200") price = 510;
        else if (quantity === "300") price = 610;
        else if (quantity === "500") price = 850;
        else if (quantity === "1000") price = 1600;
      }
    }
  ...
  const handleSubmit = () => {
    const message = `
      *Plantable Business Card (#PB0016)*:
  ...
  return (
    <div className="mx-auto px-4 py-8 max-w-full">
      ...
      <p className="text-3xl font-medium text-center text-red-600">Product Coming Soon...</p>
      ...
      {/* <div className="mt-5 flex flex-col justify-center md:flex-row"> */}
        ...
        {/* <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
          <h3 className="font-medium text-3xl">Plantable Paper Card</h3> */}
