...
import Image1 from "../assets/images/business_card/perfumed_card.jpg";
import Thumbnail1 from "../assets/images/business_card/perfumed_card.jpg";
import Thumbnail2 from "../assets/images/business_card/perfumed_card_mtrl.jpg";
import Thumbnail3 from "../assets/images/business_card/perfumed_card_mtrl2.jpg";
...
export function PerfumedCardDetails() {
  const [mainImage, setMainImage] = useState(Image1);
  const [paperStock, setPaperStock] = useState("Gold Metallic");
  ...
  const calculatePrice = () => {
    ...
    if (printingType === "Single Side") {
      if (design === "Yes Please") {
        if (quantity === "100") price = 300 + 200;
        else if (quantity === "200") price = 520 + 200;
        else if (quantity === "300") price = 740 + 200;
        else if (quantity === "500") price = 1150 + 200;
        else if (quantity === "1000") price = 1800 + 200;
      } else if (design === "No Thank You") {
        if (quantity === "100") price = 300;
        else if (quantity === "200") price = 520;
        else if (quantity === "300") price = 740;
        else if (quantity === "500") price = 1150;
    ...
    if (printingType === "Double Side") {
      if (design === "Yes Please") {
        ...
        else if (quantity === "200") price = 620 + 400;
        else if (quantity === "300") price = 880 + 400;
        else if (quantity === "500") price = 1350 + 400;
        else if (quantity === "1000") price = 2400 + 400;
      } else if (design === "No Thank You") {
        if (quantity === "100") price = 400;
        else if (quantity === "200") price = 620;
        else if (quantity === "300") price = 880;
        else if (quantity === "500") price = 1350;
        else if (quantity === "1000") price = 2400;
      }
    }
    ...
    <div className="mx-auto px-4 py-8 max-w-full">
      ...
      <div className="mt-5 flex flex-col justify-center md:flex-row">
        ...
        <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
          <h3 className="font-medium text-3xl">Perfumed Business Card</h3>
