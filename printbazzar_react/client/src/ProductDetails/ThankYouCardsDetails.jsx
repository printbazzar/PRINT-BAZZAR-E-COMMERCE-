import {
  ...
  import Image1 from "../assets/images/Invitations/thankyouCard.jpg";
  import Thumbnail1 from "../assets/images/Invitations/thankyouCard.jpg";
...
import { InvitationRelated } from "../RelatedProducts/InvitationRelated";
  ...
  export function ThankYouCardsDetails() {
        ...
        <div className="mt-5 flex flex-col justify-center md:flex-row">
          ...
          <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
            <h3 className="font-medium text-2xl sm:text-3xl flex items-center gap-5">
              Thank You Cards <br />{" "}
              <small className="text-base">(#PB0081)</small>
            </h3>
            {/* Form Fields */}
            ...
            {design === "No Thank You" && (
              <Button
                ...
                as={Link}
                to="https://www.canva.com/search?q=thankyou%20cards"
                target="_blank"
              >
