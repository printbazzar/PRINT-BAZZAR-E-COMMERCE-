import {
  ...
  import Image1 from "../assets/images/marketing_materials/a5_flyers.jpg";
  import Thumbnail1 from "../assets/images/marketing_materials/a5_flyers.jpg";
  ...
  export function A5MultiColorFlyersDetails() {
    ...
    const [size, setSize] = useState("A5 (210x148 mm)");
    ...
    const calculatePrice = () => {
      ...
      if(printingLocation === 'Single Side'){
       if (size === "A5 (210x148 mm)") {
            if (quantity === "1000") price = 2900;
            else if (quantity === "2000") price = 3350;
            else if (quantity === "3000") price = 3950;
            else if (quantity === "4000") price = 4550;
            else if (quantity === "5000") price = 5350;
            else if (quantity === "6000") price = 5950;
            else if (quantity === "7000") price = 6550;
            else if (quantity === "8000") price = 7150;
            else if (quantity === "9000") price = 7750;
            else if (quantity === "10000") price = 8950;
            else if (quantity === "20000") price = 14250;
        }
        ...
        <div className="mt-5 flex flex-col justify-center md:flex-row">
          ...
          <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
            <h3 className="font-medium text-3xl flex items-center gap-5">
              A5 Multi Color Flyers <br /> <small className="text-base">(#PB0096)</small>
            </h3>
