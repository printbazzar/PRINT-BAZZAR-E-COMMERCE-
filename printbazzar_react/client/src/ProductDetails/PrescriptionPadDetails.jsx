import {
  ...
  import Image1 from "../assets/images/business_essen/prescription_pad.jpg";
  import Thumbnail1 from "../assets/images/business_essen/prescription_pad.jpg";
...
import { BusinessEssentialsRelated } from "../RelatedProducts/BusinessEssentialsRelated";
  ...
  export function PrescriptionPadDetails() {
      ...
      <div className="mx-auto px-4 py-8 max-w-full">
        ...
        <div className="mt-5 flex flex-col justify-center md:flex-row">
          ...
          <h3 className="font-medium text-2xl sm:text-3xl flex items-center gap-5">
              Prescription Pad (Single Color)<br />{" "}
              <small className="text-base">(#PB0057)</small>
            </h3>
