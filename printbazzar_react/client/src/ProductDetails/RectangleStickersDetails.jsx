import {
  ...
  import Image1 from "../assets/images/stickers&labels/rectangle shape.jpg";
  import Thumbnail1 from "../assets/images/stickers&labels/rectangle shape.jpg";
...
import { StickersRelated } from "../RelatedProducts/StickersRelated";
  ...
  export function RectangleStickersDetails() {
    ...
    const calculatePrice = () => {
      ...
      if (size === "3x2 inch") {
        ...
        if (quantity === "25") price = 295;
        else if (quantity === "50") price = 540;
        else if (quantity === "100") price = 1035;
        else if (quantity === "150") price = 1570;
        else if (quantity === "200") price = 2065;
        else if (quantity === "300") price = 3100;
        else if (quantity === "500") price = 5165;
        else if (quantity === "750") price = 7770;
        else if (quantity === "1000") price = 10030;
      } 
      else if (size === "A4") {
        if (quantity === "25") price = 540;
        else if (quantity === "50") price = 1035;
        else if (quantity === "100") price = 2065;
        else if (quantity === "150") price = 3100;
        else if (quantity === "200") price = 4130;
        else if (quantity === "300") price = 5665;
        else if (quantity === "500") price = 8850;
        else if (quantity === "750") price = 13725;
        else if (quantity === "1000") price = 17700;
      } 
      else if (size === "A3") {
        if (quantity === "25") price = 875;
        else if (quantity === "50") price = 1750;
        else if (quantity === "100") price = 3500;
        else if (quantity === "150") price = 5100;
        else if (quantity === "200") price = 6600;
        else if (quantity === "300") price = 9600;
        else if (quantity === "500") price = 16000;
        else if (quantity === "750") price = 22500;
        else if (quantity === "1000") price = 29500;
      } 
      }  
        ...
        <div className="mt-5 flex flex-col justify-center md:flex-row">
          ...
          <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
            <h3 className="font-medium text-2xl sm:text-3xl flex items-center gap-5">
              Rectangle Stickers <br />{" "}
              <small className="text-base">(#PB0059)</small>
            </h3>
            {/* Form Fields */}
