import {
  ...
  import Image1 from "../assets/images/business_essen/lamination_certi.jpg";
  import Thumbnail1 from "../assets/images/business_essen/lamination_certi.jpg";
  import Thumbnail2 from "../assets/images/business_essen/lamination_certi_mtrl.jpg";
...
import { BusinessEssentialsRelated } from "../RelatedProducts/BusinessEssentialsRelated";
  ...
  export function LaminatedCertificatesDetails() {
    const [mainImage, setMainImage] = useState(Image1);
    const [printingLocation, setprintingLocation] = useState("Single Side");
    const [material, setMaterial] = useState("Pouch Laminated");
    ...
    const calculatePrice = () => {
      let price = 0;
        ...
        if (quantity === "5") price = 470;
        else if (quantity === "10") price = 800;
        else if (quantity === "15") price = 1120;
        else if (quantity === "20") price = 1200;
        else if (quantity === "25") price = 1375;
        else if (quantity === "50") price = 2500;
        else if (quantity === "100") price = 4700;
        ...
        <div className="mt-5 flex flex-col justify-center md:flex-row">
          ...
          <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
            <h3 className="font-medium text-3xl flex items-center gap-5">
              Laminated Certificates <br /> <small className="text-base">(#PB0027)</small>
            </h3>
        ...
        <div className="mt-5 max-w-4xl 2xl:max-w-full xl:mt-20 flex flex-col ">
          ...
          <div className="px-5 mt-5">
            ...
            <ul className="text-base leading-relaxed text-gray-500">
              {" "}
                <li>1.Print Type: Utilize digital printing for crisp and vibrant designs.</li>
                <li>2.Size: A4 (210mm x 297mm).</li>
                <li>3.Paper Type: Crafted from 300GSM Art Paper for durability and quality.</li>
                <li>4.Orientation: Available in portrait and landscape for flexibility.</li>
                <li>5.Order with multiple designs effortlessly.</li>
                <li>6.MOQ Starts from just 5 unit.</li>
            </ul>
          </div>
        </div>
