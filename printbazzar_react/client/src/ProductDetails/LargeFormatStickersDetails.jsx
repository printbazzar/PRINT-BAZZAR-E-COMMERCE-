...
import Image1 from "../assets/images/marketing_materials/lfsticker.jpg";
import Thumbnail1 from "../assets/images/marketing_materials/lfsticker.jpg";
import Thumbnail2 from "../assets/images/marketing_materials/lfsticker_mtrl2.jpg";
import Thumbnail3 from "../assets/images/marketing_materials/lfsticker_mtrl.jpg";
...
export function LargeFormatStickersDetails() {
  const [mainImage, setMainImage] = useState(Image1);
  const [width, setWidth] = useState(1);
  const [height, setHeight] = useState(1);
  const [quality, setQuality] = useState("White Vinyl");
  ...
  const handleSubmit = () => {
    const message = `
              *Large Format Stickers (#PB0043)*:
              - Sticker Width: ${width}
              - Sticker Height: ${height}
              - Sticker Quality: ${quality}
      ...
      <div className="mt-5 flex flex-col justify-center md:flex-row">
        ...
        <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
          <h3 className="font-medium text-2xl sm:text-3xl flex items-center gap-5">
            Large Format Stickers <br />{" "}
            <small className="text-base">(#PB0042)</small>
          </h3>
          <label className="block font-medium text-sm text-gray-700 mt-2 ">
          Custom Vinyl & stickers for de corating your office or home
          </label>
          ...
          <div className="mt-4">
            ...
            <Select value={method} onChange={(e) => setMethod(e.target.value)}>
              ...
              <option>Eco Inkjet Printing</option>
          ...
          {design === "No Thank You" && (
            <Button
              ...
              as={Link}
              to="https://www.canva.com/search?q=posters"
              target="_blank"
            >
      ...
      <div className="mt-5 max-w-4xl 2xl:max-w-full xl:mt-20 flex flex-col ">
        ...
        <div className="px-5 mt-5">
          ...
          <ul className="text-base leading-relaxed text-gray-500 ">
            ...
            <li>4.More than 4 Types of Stickers</li>
          </ul>
        </div>
      </div>
