import {
  ...
  import Image1 from "../assets/images/business_essen/bulk_certi.jpg";
  import Thumbnail1 from "../assets/images/business_essen/bulk_certi.jpg";
...
import { BusinessEssentialsRelated } from "../RelatedProducts/BusinessEssentialsRelated";
  ...
  export function BulkCertificatesDetails() {
    ...
    const calculatePrice = () => {
      ...
      if (quantity === "500") price = 4600;
      else if (quantity === "1000") price = 6500;
      else if (quantity === "1500") price = 8500;
      else if (quantity === "2000") price = 10500;
        ...
        <div className="mt-5 flex flex-col justify-center md:flex-row">
          ...
          <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
            <h3 className="font-medium text-3xl flex items-center gap-5">
              Bulk Certificates <br /> <small className="text-base">(#PB0029)</small>
            </h3>
