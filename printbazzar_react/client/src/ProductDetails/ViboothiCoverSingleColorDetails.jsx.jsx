import {
  ...
  import Image1 from "../assets/images/marketing_materials/viboothisc_mtrl2.jpg";
  import Thumbnail1 from "../assets/images/marketing_materials/viboothisc_mtrl2.jpg";
  import Thumbnail2 from "../assets/images/marketing_materials/viboothisc_mtrl.jpg";
  import Thumbnail3 from "../assets/images/marketing_materials/viboothisc.jpg";
  ...
  export function ViboothiCoverSingleColorDetails() {
    const [mainImage, setMainImage] = useState(Image1);
    const [printingLocation, setPrintingLocation] = useState("Single Side");
    const [size, setSize] = useState("6x8 cm");
    const [thickness, setThickness] = useState("70 gsm Maplitho Paper");
    ...
    const calculatePrice = () => {
      let price = 0;
       ...
       if(quantity === "2000") price = 1180;
       else if(quantity === "4000") price = 2150;
       else if(quantity === "6000") price = 3780;
       else if(quantity === "8000") price = 3900;
       else if(quantity === "10000") price = 4850;
    ...
    const handleSubmit = () => {
          ...
          const message = `
              *Viboothi Cover Single Color (#PB0090)*:
              - Size: ${size}
        ...
        <div className="mt-5 flex flex-col justify-center md:flex-row">
          ...
          <div className="md:ml-6 mt-4 md:mt-0 w-full md:w-1/2 2xl:w-1/2">
            <h3 className="font-medium text-3xl flex items-center gap-5">
              Viboothi Cover (Single Color)<br /> <small className="text-base">(#PB0090)</small>
            </h3>
